...
window.sfBlazor.Schedule = function () {
      ...
      if (this.parent.isTimelineView()) {
        ...
        headerCellElements.forEach(function (ele) {
          ...
          sf.base.setStyleAttribute(ele, {
            'width': sf.base.formatUnit(colWidth_1 * headerCellColSpan)
          });
        });
      }
    };
  ...
  function () {
    ...
    VerticalEvent.prototype.renderAppointments = function () {
      ...
      for (var i = 0; i < elementList.length; i++) {
        ...
        var topStartDuration = this.getTopStartDuration(ele);
        var slotPosition = this.parent.activeViewOptions.timeScale.interval / this.parent.activeViewOptions.timeScale.slotCount * 60000;
        var eleTop = topStartDuration / slotPosition * cellHeight;
        ...
        ele.style.height = (topStartDuration + this.getDuration(ele)) / slotPosition * cellHeight - eleTop + 'px';
      ...
      if (expandCollapse) {
        if (moreIndicatorElement.length > 0) {
          sf.base.removeClass([expandCollapse], DISABLE_CLASS);
        } else {
          sf.base.addClass([expandCollapse], DISABLE_CLASS);
        }
      }
  ...
  function () {
    ...
    EventBase.prototype.eventClick = function (eventData) {
      ...
      if (target.classList.contains(DRAG_CLONE_CLASS) || target.classList.contains(RESIZE_CLONE_CLASS) || eventData.detail > 1 || target.classList.contains(BLOCK_APPOINTMENT_CLASS) || target.classList.contains(INLINE_SUBJECT_CLASS)) {
        return;
      }
  ...
  function (_super) {
    ...
    MonthEvent.prototype.renderAppointments = function () {
      ...
      if (this.parent.options.currentView === 'Month' && this.parent.options.rowAutoHeight && this.parent.activeViewOptions.group.resources.length === 0) {
        var totalCells = [].slice.call(this.parent.element.querySelectorAll('.e-content-wrap table tr td:first-child'));
        var height_1 = this.parent.options.height === 'auto' ? (this.parent.element.querySelector('.e-content-wrap').clientHeight + this.parent.element.querySelector('.e-date-header-wrap').clientHeight) / totalCells.length : this.parent.element.querySelector('.e-schedule-table').clientHeight / totalCells.length;
      ...
      for (var i = 0; i < elementList.length; i++) {
        ...
        if (this.parent.options.rowAutoHeight) {
          var targetCell = target.firstElementChild;
          var rowIndex = targetCell.parentNode.sectionRowIndex;

          if (sf.base.isNullOrUndefined(cellHeights[rowIndex])) {
            cellHeights[rowIndex] = Math.ceil(targetCell.getBoundingClientRect().height);
          }

          this.updateCellHeight(targetCell, height, rowIndex, cellHeights);
        }
        ...
        var left = cellTd.offsetLeft;
        var cellHeight = cellTd.offsetHeight;

        if (this.parent.options.enableRtl) {
          appRight = cellTd.parentElement.offsetWidth - left - this.cellWidth;
        } else {
          appLeft = left;
        }
        ...
        if (!ele.classList.contains('e-more-indicator')) {
          if (!ele.classList.contains('e-block-indicator')) {
            ...
            if (this.maxOrIndicator) {
              this.setMaxEventHeight(ele, cellTd, cellHeight);
            }

            if (ele.classList.contains('e-block-appointment')) {
              sf.base.setStyleAttribute(ele, {
                'height': cellHeight - appTop - top_1 + 'px'
              });
            }
            ...
            this.updateBlockIndicator(ele, appRight, appLeft, cellTd, top_1);
          }
        } else {
    ...
    MonthEvent.prototype.updateBlockIndicator = function (ele, right, left, cell, cellTop) {
      if (this.parent.options.enableRtl) {
      ...
      ele.style.top = cellTop + cell.firstElementChild.offsetTop + 22 + 'px';
      ele.style.position = 'absolute';
    };

    MonthEvent.prototype.setMaxEventHeight = function (event, cell, cellHeight) {
      var headerHeight = this.parent.options.currentView === 'Month' ? getOuterHeight(cell.querySelector('.' + DATE_HEADER_CLASS)) : 0;
      var height = cellHeight - headerHeight - (this.maxHeight ? 2 : this.moreIndicatorHeight);
    ...
    MonthEvent.prototype.updateRowHeight = function (appHeight) {
      if (this.parent.options.rowAutoHeight) {
        ...
        if (this.parent.options.currentView === 'Month' && this.parent.element.querySelector('.' + WEEK_NUMBER_WRAPPER_CLASS)) {
          ...
          weekNumberCells.forEach(function (cell, i) {
            sf.base.setStyleAttribute(cell, {
              'height': totalCells_1[i].style.height
            });
          });
    ...
    MonthEvent.prototype.updateBlockIndicatorEle = function () {
      ...
      for (var _i = 0, blockElement_1 = blockElement; _i < blockElement_1.length; _i++) {
        ...
        if (this.parent.options.enableRtl) {
          appRight = cellTd.parentElement.offsetWidth - cellTd.offsetLeft - this.cellWidth;
        } else {
          appLeft = cellTd.offsetLeft;
        }

        this.updateBlockIndicator(element, appRight, appLeft, cellTd, cellTd.offsetTop);
      }
    };
    ...
    MonthEvent.prototype.updateBlockElements = function () {
      ...
      for (var _i = 0, blockElement_2 = blockElement; _i < blockElement_2.length; _i++) {
        ...
        var cellWidth = cellTd.offsetWidth;
        var width = Math.round(element.offsetWidth / cellWidth);
    ...
    MonthEvent.prototype.updateCellHeight = function (cell, height, rowIndex, cellHeights) {
      if (height > cellHeights[rowIndex]) {
        cellHeights[rowIndex] = height;
        sf.base.setStyleAttribute(cell, {
          'height': height + 'px'
        });
      }
  ...
  function (_super) {
    ...
    VerticalViews.prototype.highlightCurrentTime = function () {
      ...
      if (!this.parent.activeViewOptions.timeScale.enable || this.parent.isTimelineView() && this.parent.activeViewOptions.headerRows && this.parent.activeViewOptions.headerRows.length > 0 && this.parent.activeViewOptions.headerRows.slice(-1)[0].option !== 'Hour') {
        return;
      }
  ...
  function (_super) {
    ...
    TimelineEvent.prototype.getSlotDates = function () {
      ...
      if (this.parent.activeViewOptions.headerRows.length > 0 && this.parent.activeViewOptions.headerRows[this.parent.activeViewOptions.headerRows.length - 1].option !== 'Hour') {
        this.renderType = 'day';
        this.cellWidth = Math.ceil(this.content.getBoundingClientRect().width) / this.dateRender.length;
        this.slotsPerDay = 1;
      } else {
    ...
    TimelineEvent.prototype.renderAppointments = function () {
      ...
      var cellTops = [];
      var cellHeights = [];
      var isResetTop = this.parent.activeViewOptions.group.resources.length > 1 || !sf.base.isNullOrUndefined(this.parent.virtualScrollModule) || this.parent.options.rowAutoHeight;
      ...
      for (var i = 0; i < elementList.length; i++) {
        ...
        if (this.day >= 0) {
          ...
          if (sf.base.isNullOrUndefined(cellTops[resIndex])) {
            cellTops[resIndex] = this.getRowTop(resIndex, isResetTop);
          }

          var top_1 = cellTops[resIndex];
          ...
          if (!ele.classList.contains('e-more-indicator')) {
            if (!ele.classList.contains('e-block-indicator')) {
              ...
              if (this.parent.options.rowAutoHeight) {
                ...
                if (sf.base.isNullOrUndefined(cellHeights[resIndex])) {
                  cellHeights[resIndex] = Math.ceil(firstChild.getBoundingClientRect().height);
                }

                this.updateCellHeight(firstChild, height, resIndex, cellHeights);
              }
            } else {
    ...
    TimelineEvent.prototype.updateBlockElements = function () {
      ...
      for (var _i = 0, blockElement_1 = blockElement; _i < blockElement_1.length; _i++) {
        ...
        var width = Math.round(element.offsetWidth / firstChildWidth);
        element.style.width = firstChildWidth * width + 'px';
      }
      ...
      for (var _a = 0, blockIndicator_1 = blockIndicator; _a < blockIndicator_1.length; _a++) {
        ...
        var resIndex = parseInt(element.getAttribute('data-group-index'), 10);
        element.style.top = this.getRowTop(resIndex, isResetTop) + this.getFirstChild(resIndex).offsetHeight - BLOCK_INDICATOR_HEIGHT + 'px';
      }
    };
    ...
    TimelineEvent.prototype.updateCellHeight = function (cell, height, resIndex, cellHeights) {
      if (height > cellHeights[resIndex]) {
        cellHeights[resIndex] = height;
        sf.base.setStyleAttribute(cell, {
          'height': height + 'px'
        });
    ...
    TimelineEvent.prototype.getRowTop = function (resIndex, isResetTop) {
      if (this.parent.activeViewOptions.group.resources.length > 0 && !this.parent.uiStateValues.isGroupAdaptive) {
        return isResetTop ? this.parent.element.querySelector('.' + CONTENT_WRAP_CLASS + ' ' + 'tbody td[data-group-index="' + resIndex.toString() + '"]').offsetTop : this.cellHeight * resIndex;
      }
    ...
    TimelineEvent.prototype.renderEvents = function (event, resIndex, appointmentsList) {
      ...
      var isResetTop = this.parent.activeViewOptions.group.resources.length > 1 || !sf.base.isNullOrUndefined(this.parent.virtualScrollModule) || this.parent.options.rowAutoHeight;
      var top = this.getRowTop(resIndex, isResetTop);
  ...
  function (_super) {
    ...
    Month.prototype.getMonthStart = function (currentDate) {
      var isInitial = this.parent.uiStateValues.isCustomMonth && this.parent.options.currentView === 'Month' && !sf.base.isNullOrUndefined(this.parent.activeViewOptions.displayDate);
      var date = isInitial ? new Date(this.parent.activeViewOptions.displayDate) : !this.parent.uiStateValues.isCustomMonth && this.isCustomMonth() ? currentDate : firstDateOfMonth(currentDate);
    ...
    Month.prototype.isCustomMonth = function () {
      return this.parent.options.currentView === 'Month' && (!sf.base.isNullOrUndefined(this.parent.activeViewOptions.displayDate) || this.parent.activeViewOptions.numberOfWeeks > 0);
    };
  ...
  function (_super) {
    ...
    Year.prototype.renderLayout = function () {
      ...
      if (this.parent.options.currentView === 'TimelineYear') {
        ...
        if (this.parent.virtualScrollModule && !isHorizontal) {
          this.parent.virtualScrollModule.setTranslateValue();
        }
      }
    ...
    Year.prototype.onDataReady = function () {
      ...
      if (this.parent.options.currentView === 'TimelineYear') {
        ...
        var cellTops = [];
        var moreIndicatorOffsetHeight = void 0;
        ...
        for (var i = 0; i < appointments.length; i++) {
          ...
          if (!sf.base.isNullOrUndefined(cellData)) {
            var rowIndex = cellData.parentNode.sectionRowIndex;

            if (sf.base.isNullOrUndefined(cellTops[rowIndex])) {
              cellTops[rowIndex] = cellData.offsetTop;
            }

            if (ele.classList.contains('e-appointment')) {
              cellTop = cellTops[rowIndex] + cellHeader + eventHeight * levelIndex + EVENT_GAP;
              ...
              if (sf.base.isNullOrUndefined(moreIndicatorOffsetHeight)) {
                moreIndicatorOffsetHeight = ele.getBoundingClientRect().height;
              }

              cellTop = cellTops[rowIndex] + (cellHeight - moreIndicatorOffsetHeight);
              width = cellWidth - 2;
            }
    ...
    Year.prototype.updateRowHeight = function () {
      if (this.parent.options.rowAutoHeight) {
        var data = {
          cssProperties: this.parent.getCssProperties(),
          isPreventScrollUpdate: true,
    ...
    Year.prototype.getStartDate = function () {
      return new Date(this.parent.options.selectedDate.getFullYear(), this.parent.activeViewOptions.firstMonthOfYear - 1 % 12, 1);
    };

    Year.prototype.getEndDate = function () {
      return addDays(addMonths(this.getStartDate(), this.parent.activeViewOptions.monthsCount), -1);
    };
  ...
  function () {
    ...
    WorkCellInteraction.prototype.cellClick = function (e) {
      if (this.isPreventAction(e) || sf.base.closest(e.target, '.' + DISABLE_DATES) || e.detail > 1 || this.parent.options.quickInfoOnSelectionEnd) {
        return;
      }
      ...
      if (sf.base.isNullOrUndefined(target) || target.classList.contains(HEADER_CELLS_CLASS) && this.parent.options.currentView === 'Month') {
        return;
      }
  ...
  function () {
    ...
    KeyboardInteraction.prototype.keyActionHandler = function (e) {
      switch (e.action) {
        ...
        case 'fTwelve':
          if (this.parent.options.allowInline && this.parent.inlineModule) {
            e.preventDefault();
    ...
    KeyboardInteraction.prototype.onMoveup = function (e) {
      ...
      if (this.parent.options.currentView === 'TimelineYear' && target.classList.contains(OTHERMONTH_CLASS)) {
        return;
      }
    ...
    KeyboardInteraction.prototype.processEnter = function (e) {
      ...
      if (this.parent.options.currentView === 'TimelineYear' && e.target.classList.contains(OTHERMONTH_CLASS)) {
        return;
      }
      ...
      if (target.classList.contains(WORK_CELLS_CLASS) || target.classList.contains(ALLDAY_CELLS_CLASS)) {
        ...
        if (this.parent.options.allowInline) {
          ...
          if (this.parent.options.currentView === 'Year') {
            target.click();
          } else {
            this.parent.dotNetRef.invokeMethodAsync('TriggerCellClick', args);
          }
    ...
    KeyboardInteraction.prototype.getCells = function (isInverseTable, start, end) {
      ...
      var isTimelineYear = this.parent.options.currentView === 'TimelineYear';
    ...
    KeyboardInteraction.prototype.focusFirstCell = function () {
      ...
      if (this.parent.isTimelineView() && this.parent.options.currentView !== 'TimelineYear') {
      ...
      } else if (this.parent.options.currentView.indexOf('Year') > -1) {
        var query = '.' + WORK_CELLS_CLASS + ':not(.' + OTHERMONTH_CLASS + ')' + ':not(.' + RESOURCE_GROUP_CELLS_CLASS + ')';
        var isVerticalYear = this.parent.options.currentView === 'TimelineYear' && this.parent.activeViewOptions.orientation === 'Vertical';
        query += isVerticalYear ? '[data-date="' + addLocalOffset(this.parent.activeView.getStartDate()).getTime() + '"]' : '';
    ...
    KeyboardInteraction.prototype.selectCells = function (isMultiple, targetCell) {
      ...
      if (isMultiple) {
        ...
        var views = ['Day', 'Week', 'WorkWeek', 'TimelineDay', 'TimelineWeek', 'TimelineWorkWeek', 'TimelineMonth', 'TimelineYear'];

        if (!this.parent.options.allowMultiRowSelection) {
          var isTimelineYear = this.parent.options.currentView === 'TimelineYear';

          if (isTimelineYear && this.parent.activeViewOptions.orientation === 'Horizontal' || this.parent.options.currentView === 'Month') {
            var isGroupYear = this.parent.options.currentView === 'TimelineYear' && this.parent.activeViewOptions.group.resources.length > 0;
            target = isGroupYear ? this.initialTarget : this.initialTarget.parentElement.children[target.cellIndex];
          } else if (views.indexOf(this.parent.options.currentView) > -1) {
    ...
    KeyboardInteraction.prototype.cancelUpDownAction = function (isTimelineYear) {
      ...
      if (this.parent.isTimelineView() && !isTimelineYear || this.parent.options.currentView === 'MonthAgenda') {
        return true;
      }
    ...
    KeyboardInteraction.prototype.processUp = function (e, isMultiple) {
      ...
      if (isMultiple && this.cancelUpDownAction(isTimelineYear) || this.preventYearNavigation()) {
        return;
      }
      ...
      if (target.classList.contains(WORK_CELLS_CLASS) && !this.parent.element.querySelector('.' + POPUP_OPEN)) {
        ...
        if ((curRowIndex > 0 || targetCell) && curRowIndex < tableRows.length) {
          ...
          if (this.parent.options.currentView === 'Year' && targetCell.classList.contains(OTHERMONTH_CLASS)) {
            if (addLocalOffset(this.parent.activeView.getStartDate()).getTime() < +targetCell.getAttribute('data-date')) {
    ...
    KeyboardInteraction.prototype.processDown = function (e, isMultiple) {
      ...
      if (target.classList.contains(WORK_CELLS_CLASS) && !this.parent.element.querySelector('.' + POPUP_OPEN)) {
        ...
        if (curRowIndex >= 0 && (curRowIndex < tableRows.length - 1 || targetCell)) {
          ...
          if (this.parent.options.currentView === 'Year' && targetCell.classList.contains(OTHERMONTH_CLASS)) {
            if (addLocalOffset(this.parent.activeView.getEndDate()).getTime() > +targetCell.getAttribute('data-date')) {
    ...
    KeyboardInteraction.prototype.getHorizontalUpDownCell = function (tableRows, target, curRowIndex, isUp) {
      ...
      if (cell.classList.contains(OTHERMONTH_CLASS)) {
        ...
        var query = '[data-date="' + addLocalOffset(lastDateOfMonth(date)).getTime() + '"]';
    ...
    KeyboardInteraction.prototype.processLeftRight = function (target) {
      var tableEle = this.parent.options.currentView === 'Year' ? target.closest('tbody') : this.parent.getContentTable();
    ...
    KeyboardInteraction.prototype.isCancelLeftRightAction = function (e, isMultiple, isTimelineYear) {
      var prevent = this.parent.options.currentView === 'MonthAgenda' || isTimelineYear && this.initialTarget.classList.contains(OTHERMONTH_CLASS);

      if (this.parent.options.currentView === 'Agenda' || isMultiple && prevent || this.preventYearNavigation()) {
        return true;
      }
    ...
    KeyboardInteraction.prototype.processRight = function (e, isMultiple) {
      ...
      if (target.classList.contains(WORK_CELLS_CLASS) && e.target.classList.contains(WORK_CELLS_CLASS)) {
        ...
        var isMonthEnd = this.parent.options.currentView === 'Year' && targetDate.getTime() === addLocalOffset(lastDateOfMonth(targetDate)).getTime();
        ...
        if (key.columnIndex >= 0 && key.columnIndex < key.maxIndex - 1 && !isMonthEnd) {
          ...
          if (!this.isInverseTableSelect() && key.rowIndex < key.element.rows.length - 1 && !isMonthEnd) {
            ...
            if (isMonthEnd && targetDate.getTime() !== addLocalOffset(this.parent.activeView.getEndDate()).getTime()) {
    ...
    KeyboardInteraction.prototype.processLeft = function (e, isMultiple) {
      ...
      if (e.target.classList.contains(WORK_CELLS_CLASS) && target.classList.contains(WORK_CELLS_CLASS)) {
        var key = this.processLeftRight(target);
        var targetDate = new Date(+target.getAttribute('data-date'));
        var isMonthStart = this.parent.options.currentView === 'Year' && targetDate.getTime() === addLocalOffset(firstDateOfMonth(targetDate)).getTime();
        ...
        if (key.columnIndex > 0 && key.columnIndex < key.maxIndex && !isMonthStart) {
          ...
          if (!this.isInverseTableSelect() && key.rowIndex > 0) {
            ...
            if (isMonthStart && targetDate.getTime() !== addLocalOffset(this.parent.activeView.getStartDate()).getTime()) {
    ...
    KeyboardInteraction.prototype.preventYearNavigation = function () {
      return this.parent.options.currentView === 'Year' && this.initialTarget.classList.contains(OTHERMONTH_CLASS);
    };
    ...
    KeyboardInteraction.prototype.getVerticalLeftRightCell = function (target, isRight) {
      ...
      var start = addLocalOffset(new Date(date.getFullYear(), date.getMonth() + (isRight ? 1 : -1), 1));
      var tableEle = this.parent.getContentTable();
      ...
      return tableEle.querySelector('[data-date="' + addLocalOffset(lastDateOfMonth(start)).getTime() + '"]');
    };
    ...
    KeyboardInteraction.prototype.processTab = function (e, isReverse) {
      ...
      if (target.classList.contains(INLINE_SUBJECT_CLASS) && this.parent.inlineEdit) {
        target = target.closest('.e-appointment');
        this.parent.inlineCrudActions(e.target);
      }
      ...
      if (target.classList.contains(APPOINTMENT_CLASS)) {
        ...
        var selectedAppointments = this.parent.eventBase.getSelectedAppointments();
        var isTimelineYear = this.parent.options.currentView === 'TimelineYear';
        var isTimeline = this.parent.isTimelineView() && !isTimelineYear;
  ...
  function (_super) {
    ...
    Resize.prototype.resizeStart = function (e) {
      ...
      var resizeArgs = {
        ...
        interval: Math.round(this.actionObj.interval),
        scroll: {
          enable: true,
          scrollBy: 30,
          timeDelay: 100
      ...
      this.parent.dotNetRef.invokeMethodAsync('OnResizeStart', resizeArgs, dataGuid).then(function (dataObj) {
        var resizeEventArgs = dataObj.resizeEventArgs;

        if (Math.round(_this.actionObj.interval) === resizeEventArgs.interval) {
          resizeEventArgs.interval = _this.actionObj.interval;
        }
    ...
    Resize.prototype.horizontalResizing = function (isLeft) {
      ...
      if (this.parent.isTimelineView()) {
        ...
        var offset$$1 = parseFloat(this.parent.options.enableRtl ? this.actionObj.clone.style.right : this.actionObj.clone.style.left);
        offset$$1 = Math.round(offset$$1 / pixelsPerMinute) * pixelsPerMinute;
        ...
        if (['Year', 'Month', 'Week', 'Date'].indexOf(headerName) !== -1) {
          ...
          cellIndex = isLeft ? Math.floor(offset$$1 / this.actionObj.cellWidth) : Math.ceil((offset$$1 + (this.actionObj.clone.getBoundingClientRect().width - cellWidth)) / this.actionObj.cellWidth);
          ...
          if (this.parent.options.enableRtl) {
            ...
            var offsetWidth = Math.floor(offset$$1 / this.actionObj.cellWidth) * this.actionObj.cellWidth + (isLeft ? 0 : this.actionObj.clone.getBoundingClientRect().width - cellOffsetWidth);
        ...
        if (['TimelineMonth', 'Year', 'Month', 'Week', 'Date'].indexOf(headerName) !== -1 || !this.parent.activeViewOptions.timeScale.enable) {
          ...
          if (!isLeft) {
            offset$$1 += this.actionObj.clone.getBoundingClientRect().width;
          }

          var spanMinutes = Math.ceil(this.actionObj.slotInterval / this.actionObj.cellWidth * (offset$$1 - Math.floor(offset$$1 / this.actionObj.cellWidth) * this.actionObj.cellWidth));
    ...
    Resize.prototype.getLeftRightStyles = function (e, isLeft) {
      ...
      var targetWidth = isTimelineView ? this.actionObj.element.getBoundingClientRect().width / this.actionObj.cellWidth * this.actionObj.cellWidth : this.parent.options.currentView === 'Month' || !this.parent.isTimelineView() && !this.parent.activeViewOptions.timeScale.enable ? this.actionObj.element.getBoundingClientRect().width : Math.ceil(this.actionObj.element.getBoundingClientRect().width / this.actionObj.cellWidth) * this.actionObj.cellWidth;
      ...
      var width = !isLeft && offsetWidth + this.actionObj.clone.offsetLeft > this.scrollArgs.width ? this.actionObj.clone.getBoundingClientRect().width : offsetWidth < this.actionObj.cellWidth ? this.actionObj.cellWidth : offsetWidth;
  ...
  function (_super) {
    ...
    DragAndDrop.prototype.dragStart = function (e) {
      ...
      this.parent.dotNetRef.invokeMethodAsync('OnDragStart', dragArgs, eventGuid, eventGuids).then(function (dragData) {
        var dragEventArgs = dragData.dragEventArgs;

        if (Math.round(_this.actionObj.interval) == dragEventArgs.interval) {
          dragEventArgs.interval = _this.actionObj.interval;
        }
  ...
  function () {
    ...
    VirtualScroll.prototype.setTranslateValue = function () {
      ...
      if (conTable.classList.contains('e-virtual-relative')) {
        sf.base.removeClass([conTable], 'e-virtual-relative');
      }
    ...
    VirtualScroll.prototype.beforeInvoke = function (resWrap, conWrap, eventWrap, timeIndicator) {
      ...
      if (document.activeElement && document.activeElement.classList.contains(RESOURCE_CELLS_CLASS)) {
        ...
        this.focusedEle = document.activeElement;
        this.parent.element.focus();
      }
    ...
    VirtualScroll.prototype.setTabIndex = function () {
      ...
      if (resCells && resColWrap) {
        var resWrapTop_1 = resColWrap.getBoundingClientRect().top;
        resCells.forEach(function (element) {
          if (element.getBoundingClientRect().top >= resWrapTop_1) {
            element.setAttribute('tabindex', '0');
          } else {
            element.setAttribute('tabindex', '-1');
          }
      ...
      if (this.focusedEle) {
        focusResCell = this.parent.element.querySelector("." + RESOURCE_CELLS_CLASS + "[tabindex=\"" + 0 + "\"][data-group-index=\"" + this.focusedEle.getAttribute('data-group-index') + "\"]");
      }

      if (!focusResCell) {
        focusResCell = this.parent.element.querySelector("." + RESOURCE_CELLS_CLASS + "[tabindex=\"" + 0 + "\"]");
      }
    ...
    VirtualScroll.prototype.updateContent = function () {
      var selector = '.' + APPOINTMENT_CLASS + ':not(.e-schedule-event-clone),.' + MORE_INDICATOR_CLASS;
  ...
  function () {
    ...
    SfSchedule.prototype.createQuickPopup = function (guid, isServerBinding, isPrevent) {
      ...
      if (!sf.base.isNullOrUndefined(guid)) {
        ...
        if (this.element.querySelectorAll('.e-appointment[data-guid="' + guid + '"]').length > 1 && this.activeEventData && !sf.base.isNullOrUndefined(this.activeEventData.element) && this.activeEventData.element.getAttribute('data-guid') === guid) {
          this.currentCell = this.activeEventData.element;
        }
    ...
    SfSchedule.prototype.applyEventColor = function () {
      ...
      if (getComputedStyle(footerEle).display === 'block') {
        ...
        if (colorEle) {
          ...
          color = "rgba(" + color.match(/\d+/g).slice(0, 3).join() + ",0.3)";
        }
      }
    ...
    SfSchedule.prototype.createMoreEventPopup = function (clsName, dataDate) {
      ...
      if (this.morePopup) {
        if (this.options.currentView === 'Year') {
          var targetCell = this.element.querySelector(':not(.' + OTHERMONTH_CLASS + ')[data-date="' + dataDate + '"]');

          if (targetCell) {
            this.activeCellsData = this.getCellDetails(targetCell);
          }
        }
        ...
        var targetElement = this.element.querySelector('.' + clsName + '[data-date="' + dataDate + '"]');

        if (this.options.currentView === 'Year') {
          targetElement = clsName.indexOf('e-other-month') !== -1 ? sf.base.closest(targetElement, '.' + OTHERMONTH_CLASS) : this.element.querySelector(':not(.' + OTHERMONTH_CLASS + ')[data-date="' + dataDate + '"]');
        }

        if (this.morePopup && this.isAdaptive) {
          sf.base.addClass([this.morePopup.element], 'e-device');
        }

        this.morePopup.relateTo = targetElement;
        this.morePopup.show();
      }
    };
    ...
    SfSchedule.prototype.onMoreEventPopupClose = function () {
      if (this.morePopup && this.morePopup.element.classList.contains(POPUP_OPEN)) {
        if (this.options.currentView === 'Year' && this.activeCellsData && this.activeCellsData.element) {
    ...
    SfSchedule.prototype.onDocumentClick = function (e) {
      ...
      if (this.options.allowInline) {
        var subjectElement = this.element.querySelector('.' + INLINE_SUBJECT_CLASS);

        if (!target.classList.contains(INLINE_SUBJECT_CLASS) && subjectElement && subjectElement.value !== '') {
          this.inlineCrudActions(subjectElement);
        } else if (!target.classList.contains(INLINE_SUBJECT_CLASS)) {
          this.inlineModule.removeInlineAppointmentElement();
        }
      }
  ...
  var Schedule = {
    ...
    addSelectedEventClass: function addSelectedEventClass(element, guid) {
      if (element && element.blazor__instance && element.blazor__instance.eventBase) {
        element.blazor__instance.eventBase.addSelectedAppointments([].slice.call(element.querySelectorAll('div[data-guid="' + guid + '"]')));
      }
    },
    addSelectedClass: function addSelectedClass(element) {
      if (element && element.blazor__instance && element.blazor__instance.currentCell) {
        element.blazor__instance.selectCell(element.blazor__instance.currentCell);
      }
    },
    ...
    getRowIndex: function getRowIndex(element, left, top) {
      if (element && element.blazor__instance) {
        ...
        if (target) {
          targetElement = sf.base.closest(target, '.' + RESOURCE_CELLS_CLASS);
          return JSON.stringify(targetElement.parentNode.sectionRowIndex.toString());
        }
