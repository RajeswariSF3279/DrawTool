    ...
    */
    ...
    updatePageBreaks: function updatePageBreaks(backgroundImageId, backgroundId, x, y, width, height, transform, collection, tX, tY, currentZoom, showPageBreaks) {
      ...
      if (backgroundImage.children.length > 0) {
        backgroundImage.setAttribute("x", x);
        backgroundImage.setAttribute("y", y);
    ...
    textEdit: function textEdit(annotation, diagramId, centerPoint, nodeBounds, transform, canZoomTextEdit, annottaionId) {
      var _this = this;
    ...
    onAddWireEvents: function onAddWireEvents(id, component) {
      ...
      window.addEventListener('resize', function (e) {
        setTimeout(function () {
          this.invokeDiagramEvents(e, windowReizeDiagramComponent, scrollDiagramID);
        }, 800);
      });
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              canvas = _a.sent();
              image = content = storeFormat = options.format === 'JPEG' ? canvas.toDataURL('image/jpeg') : options.format === 'PNG' ? canvas.toDataURL('image/png') : options.format === 'BMP' ? canvas.toDataURL('image/bmp') : canvas.toDataURL();
